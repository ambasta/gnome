...
inherit gnome-meson python-r1 systemd udev virtualx
...
PATCHES=(
	"${FILESDIR}"/3.28.1-optional-wacom.patch
)
...
src_configure() {
	gnome-meson_src_configure \
		...
		$(meson_use input_devices_wacom enable-wacom) \
		$(meson_use udev enable-gudev) \
		$(meson_use networkmanager enable-network_manager) \
		$(meson_use smartcard enable-smartcard) \
		$(meson_use cups enable-cups) \
